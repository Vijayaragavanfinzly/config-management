...
@Component({
  selector: 'app-compare-only-env',
  standalone: true,
  imports: [RouterModule, CommonModule, FormsModule, NgSelectComponent, MatTabsModule, MatTooltipModule, SpinnerComponent],
  templateUrl: './compare-only-env.component.html',
  styleUrl: './compare-only-env.component.css'
})
export class CompareOnlyEnvComponent implements OnInit {
  tenants: any[] = [];
  tenantNames: string[] = [];
  ...
  differentColumns = [
    ...
    { name: 'Actions T1', field: 'actionsT1', width: 120 },
      ...
      this.compareService.compareLiveEnvironments(this.selectedEnv1.toLowerCase(), this.selectedEnv2.toLowerCase()).subscribe({
        next: (data) => {
          console.log('Comparison result:', data);
            ...
            this.TenantBasedProperties = data.TenantProperties;
            this.CommonProperties = data.CommonProperties;
            this.TenantMatchingProperties = this.TenantBasedProperties.Matching;
            this.TenantNonMatchingProperties = this.TenantBasedProperties.NonMatching;
            this.CommonMatchingProperties = this.CommonProperties.Matching;
            this.CommonNonMatchingProperties = this.CommonProperties.NonMatching;

            this.tenantBasedSized = Object.keys(this.TenantMatchingProperties).length + Object.keys(this.TenantNonMatchingProperties).length;
            this.nonTenantBasedSize = Object.keys(this.CommonMatchingProperties).length + Object.keys(this.CommonNonMatchingProperties).length;
            ...
            console.log(this.tenantPropertySameSize);
            console.log(this.tenantPropertyDifferentSize);
            console.log(this.nonTenantPropertySameSize);
            console.log(this.nonTenantPropertyDifferentSize);
            ...
            // this.totalSize = this.comparisonData.length;
            ...
            // console.log(this.filteredSameData);
            // console.log(this.filteredDifferentData);
  ...
  updatePagination() {
    if(this.activeTab === 'tenant' && this.selectedFilter === 'Matching'){
      this.totalPages = Math.ceil(this.TenantMatchingProperties.length / this.pageSize);
      ...
      this.totalPages = Math.ceil(this.TenantNonMatchingProperties.length / this.pageSize);
      if (this.currentPage > this.totalPages) {
        this.currentPage = this.totalPages;
      }
      this.pages = this.getVisiblePages();
      ...
      this.totalPages = Math.ceil(this.CommonMatchingProperties.length / this.pageSize);
      if (this.currentPage > this.totalPages) {
        this.currentPage = this.totalPages;
      }
      this.pages = this.getVisiblePages();
      ...
      this.totalPages = Math.ceil(this.CommonNonMatchingProperties.length / this.pageSize);
      if (this.currentPage > this.totalPages) {
        this.currentPage = this.totalPages;
      }
      this.pages = this.getVisiblePages();
    ...
    getPaginatedData(): any {
      ...
      let length = 0;
      if(this.activeTab === 'tenant' && this.selectedFilter === 'Matching'){
        length = this.TenantMatchingProperties.length;
      }
      else if(this.activeTab === 'tenant' && this.selectedFilter !== 'Matching'){
        length = this.TenantNonMatchingProperties.length;
      }
      else if(this.activeTab === 'common' && this.selectedFilter === 'Matching'){
        length = this.CommonMatchingProperties.length;
      }
      else if(this.activeTab === 'common' && this.selectedFilter !== 'Matching'){
        length = this.CommonNonMatchingProperties.length;
      }
      ...
      if(this.activeTab === 'tenant' && this.selectedFilter === 'Matching'){
        return this.TenantMatchingProperties.slice(startIndex, endIndex);
      }
      else if(this.activeTab === 'tenant' && this.selectedFilter !== 'Matching'){
        return this.TenantNonMatchingProperties.slice(startIndex, endIndex);
      }
      else if(this.activeTab === 'common' && this.selectedFilter === 'Matching'){
        return this.CommonMatchingProperties.slice(startIndex, endIndex);
      }
      else if(this.activeTab === 'common' && this.selectedFilter !== 'Matching'){
        return this.CommonNonMatchingProperties.slice(startIndex, endIndex);
      }
    }
